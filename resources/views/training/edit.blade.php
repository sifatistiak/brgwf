...
@section('title', 'BRGWF Training Edit')
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-group col-md-4" id="duration"
                                    name="duration" value="{{ $training->duration }}">
                                <span class="input-group-addon col-md-1"></span>
                                <label class="col-md-2" for="serial_no">Serial No</label>
                                <input type="text" class="form-control input-group col-md-3" id="serial_no"
                                    name="serial_no" value="{{ $training->serial_no }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control input-group col-md-4" id="start_date"
                                    name="start_date" value="{{ $training->start_date }}">
                                <span class="input-group-addon col-md-1"></span>
                                <label class="col-md-2" for="end_date">End Date</label>
                                <input type="date" class="form-control input-group col-md-3" id="end_date"
