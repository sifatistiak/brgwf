...
@section('title', 'BRGWF Non MemberShip')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <p class="mb-0">Non Membership</p>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('non-member.store') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
