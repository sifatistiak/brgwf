                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control input-group col-md-3" value="{{ date('Y-m-d') }}" readonly id="transaction_date" name="transaction_date">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-group col-md-3" id="name" name="name" readonly>
                                        <span class="input-group-addon col-md-1"></span>
                                        <label class="col-md-2" for="ref_name">Ref Name</label>
                                        <input type="text" class="form-control input-group col-md-3" id="ref_name" name="ref_name" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-group col-md-9" id="remarks" name="remarks">
