...
@section('title', env('Site_Title', 'BRGWF').' Category Edit')
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('category.update',$item->id) }}" method="post">
                    @method('PUT')
                    @csrf
                    <div class="box-body">
                    ...
                    <div class="box-footer mt-5">
                        <a href="{{ route('category.index') }}" class="btn btn-info">Back to List</a>
